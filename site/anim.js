...
(function () {
  ...
  // ─── 4. Stagger reveal для решёток (карточки номинаций, новости, программа, партнёры) ───
  const grids = [
    { sel: '.nom-grid', items: '.nom-card' },
  ...
  // ─── 6. 3D-tilt при hover на карточках номинаций и новостей ───
